...
<style>
    .stApp {
        background:
            radial-gradient(circle at 15% 15%, rgba(100, 55, 220, 0.16), transparent 32%),
            radial-gradient(circle at 85% 80%, rgba(0, 210, 230, 0.12), transparent 32%),
            linear-gradient(135deg, #050b1d 0%, #09152e 48%, #08051e 100%);
        color: #f7f8ff;
    }
